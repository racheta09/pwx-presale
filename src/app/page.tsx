                ...
                >
                    ...
                    >
                        <Grid
                            ...
                            sm={12}
                            lg={6}
                            className="bg-[url(/bg2.jpg)] bg-center p-5"
                        >
                            <Paper
                                // elevation={24}
                                style={{
                            ...
                            >
                                ...
                                <h6 className="text-center">
                                    1st round 50,00,000 tokens @0.005 $ For 4
                                    days
                                </h6>
                                <Timer deadline={"June 3, 2023 10:00:00"} />
                                <h6 className="text-center">
                                    2nd round50,00,000 tokens @ 0.007 $ For 4
                                    days
                                </h6>
                                <h6 className="text-center">
                                    3rd round 50,00,000 tokens @ 0.009 $ for 4
                                    days
                                </h6>
                                <h6 className="text-center">
                        ...
                        <Grid
                            ...
                            sm={12}
                            lg={6}
                            className="bg-[url(/bg1.jpg)] bg-center gap-2 p-5"
                        >
                            {/* <Grid
                                container
                                item
                            ...
                            >
                                ...
                                {[...Array(totalTransactions?.toNumber())].map(
                                    (item, index) => (
                                        <BuyData
                                            key={index}
